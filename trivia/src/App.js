        ...
        <div>
            ...
            <div className="directions">
                {question ? (
                    ...
                    <h3>
                        Welcome to Trivia Night!! Below are several categories
                        that you can choose your trivia questions to generate
                        from. Each question will have multiple choice answers
                        below it for you to select from. At any time you can
                        return to the home screen by pressing the home button
                        under the answers. Good luck!!!
                    </h3>
                )}
            </div>
            <div>
